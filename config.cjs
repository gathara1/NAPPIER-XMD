...
const config = {
  ...
  MENU_IMAGE: process.env.MENU_IMAGE || "https://files.catbox.moe/99ofzd.jpg",
  DESCRIPTION: process.env.DESCRIPTION || "Powerful WhatsApp Bot by Gathara",
  OWNER_NAME: process.env.OWNER_NAME || "Gathara",
