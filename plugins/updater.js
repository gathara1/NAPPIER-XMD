  ...
  try {
    ...
    if (!isCreator) {
      return Matrix.sendMessage(m.from, {
        text: `◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ Piss off, wannabe! Only *NAPPIER-XMD* or its boss can update this beast! 😤🔪
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`,
      }, { quoted: m });
    }
    ...
    const msg = await Matrix.sendMessage(
      m.from,
      { text: `◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *NAPPIER-XMD* is sniffin' for updates, fam! Hold tight... 🕵️‍♂️
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈` },
      { quoted: m }
    );
    ...
    // Fetch latest commit hash - Update with your repo
    const { data: commitData } = await axios.get("https://api.github.com/repos/gathara1/NAPPIER-XMD/commits/main", {
    ...
    if (!fs.existsSync(packageJsonPath)) {
      await m.React("❌");
      return editMessage(`◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *NAPPIER-XMD* can't find package.json, fam! Shit's broken! 😣
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`);
    }
    ...
    if (latestCommitHash === currentHash) {
      await m.React("✅");
      return editMessage(`◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *NAPPIER-XMD* is fresh as fuck, fam! No updates needed! 😎🔥
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`);
    }

    await editMessage(`◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ New *NAPPIER-XMD* update found! Snatchin' that shit now... 🚀
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`);

    // Download latest ZIP - Update with your repo
    const zipPath = path.join(process.cwd(), "latest.zip");
    const writer = fs.createWriteStream(zipPath);
    const response = await axios({
      method: "get",
      url: "https://github.com/gathara1/NAPPIER-XMD/archive/main.zip",
      responseType: "stream",
    });
    ...
    await editMessage(`◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *NAPPIER-XMD* is rippin' open that ZIP, fam... 📦
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`);
    ...
    await editMessage(`◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ Swappin' out the old shit for new *NAPPIER-XMD* heat... 🔄
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`);

    // Replace files, skip configs
    const sourcePath = path.join(extractPath, "NAPPIER-XMD-main");
    ...
    await editMessage(`◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *NAPPIER-XMD* update locked in! Restarting to flex the new shit... ♻️🔥
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`);
    ...
    await Matrix.sendMessage(
      ...
      {
        text: `◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *NAPPIER-XMD* fucked up the update, fam! Error: ${error.message} 😈
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`,
      },
      { quoted: m }
    );
