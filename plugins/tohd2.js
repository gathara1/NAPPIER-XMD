  ...
  try {
    ...
    if (!m.quoted || m.quoted.mtype !== "imageMessage") {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, *NAPPIER-XMD* needs a quoted image to enhance, fam! 📸
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *NAPPIER-XMD* crankin' up that image quality... 🔍✨
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
    ...
    await Matrix.sendMessage(
      m.from,
      {
        ...
        caption: `◈━━━━━━━━━━━━━━━━◈
│❒ *NAPPIER-XMD* made your image HD AF, fam! 🖼️🔥
◈━━━━━━━━━━━━━━━━◈`,
      },
      { quoted: m }
    );
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *NAPPIER-XMD* hit a snag enhancin' that pic, fam! Try again! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};
